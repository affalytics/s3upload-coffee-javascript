...
(function() {
  window.S3Upload = (function() {
    ...
    S3Upload.prototype.session_token = '';
    ...
    S3Upload.prototype.executeOnSignedUrl = function(file, callback) {
      ...
      xhr.open('GET', this.s3_sign_put_url + '?s3_object_type=' + file.type + '&s3_object_name=' + this.s3_object_name + '&session_token=' + this.session_token, true);
